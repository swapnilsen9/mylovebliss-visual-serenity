      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className={`text-2xl font-fredoka ${
            isScrolled ? 'text-brand-primarywhite' : 'text-brand-primarywhite'
          }`}>
            MyLoveBliss
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 py-4 glass-effect rounded-lg">
            <nav className="flex flex-col space-y-4 px-4">
              <button onClick={() => scrollToSection('home')} className="font-larken text-brand-primarywhite hover:text-brand-accent transition-colors text-left font-medium">Home</button>
